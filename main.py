...
for i in range(len(best_run_throughs)):
    ...
    print("Episode {} Average Reward {} Best Reward {} Last Reward {} Epsilon {}".format(episode, average_reward/episode, best_reward, score, agent.exploration_rate))
